...
# D Major
song5 = [
    ['c', 4], ['d', 4], ['e', 4], ['f#', 4], ['g', 4], ['a', 4], ['b', 4], ['c5#', 4], ['d5', 4], ['e5', 4],
    ['f5#', 4], ['g5', 4], ['a5', 4]
    ]
...
#G Major
song7 = [
    ['c', 4], ['d', 4], ['e', 4], ['f#', 4], ['g', 4], ['a', 4], ['b', 4], ['c', 4], ['d', 4], ['e', 4],
    ['f#', 4], ['g', 4], ['a', 4]
    ]
...
# E-flat major
song9 = [
    ['c', 4], ['d', 4], ['eb', 4], ['f', 4], ['g', 4], ['ab5', 4], ['bb5', 4], ['c5', 4], ['d', 4], ['eb5', 4],
    ['f5', 4], ['g5', 4], ['ab6', 4]
    ]

# F major
song10 = [
    ['c', 4], ['d', 4], ['e', 4], ['f', 4], ['g', 4], ['a5', 4], ['bb5', 4], ['c5', 4], ['d', 4], ['e5', 4],
    ['f5', 4], ['g5', 4], ['a6', 4]
    ]

# A-flat major
song11 = [
    ['c', 4], ['db', 4], ['eb', 4], ['f', 4], ['g', 4], ['ab5', 4], ['bb5', 4], ['c5', 4], ['db5', 4], ['eb5', 4],
    ['f5', 4], ['g5', 4], ['ab6', 4]
    ]

# B-flat major
song12 = [
    ['c', 4], ['d', 4], ['eb', 4], ['f', 4], ['g', 4], ['a5', 4], ['bb5', 4], ['c5', 4], ['d', 4], ['eb5', 4],
    ['f5', 4], ['g5', 4], ['a6', 4]
    ]

# C-sharp major
song13 = [
    ['c#', 4], ['d#', 4], ['e#', 4], ['f#', 4], ['g#', 4], ['a#5', 4], ['b#5', 4], ['c#5', 4], ['d#5', 4], ['e#5', 4],
    ['f#5', 4], ['g#5', 4], ['a#6', 4]
...
# D-flat major
song14 = [
    ['c', 4], ['db', 4], ['eb', 4], ['f', 4], ['gb', 4], ['ab5', 4], ['bb5', 4], ['c5', 4], ['db5', 4], ['eb5', 4],
    ['f5', 4], ['gb5', 4], ['a6', 4]

    ]
# F-sharp major
song15 = [
    ['c#', 4], ['d#', 4], ['e#', 4], ['f#', 4], ['g#', 4], ['a#5', 4], ['b5', 4], ['c#5', 4], ['d#5', 4], ['e#5', 4],
    ['f#5', 4], ['g#5', 4], ['a#6', 4]
    ]
# G-flat major
song16 = [
 ...
 # B major              # 'song18' since chronological 'song17' has been assigned to C-flat major already
song18 = [
    ['c#', 4], ['d#', 4], ['e', 4], ['f#', 4], ['g#', 4], ['a#5', 4], ['b5', 4], ['c#5', 4], ['d#5', 4], ['e5', 4],
    ['f#5', 4], ['g#5', 4], ['a#6', 4]
    ]
